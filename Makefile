...
CC			:=	cc
CFLAGS		:=	-I $(shell brew --prefix readline)/include -Wall -Werror -Wextra -g -fsanitize=address
MFLAGS		:=	-Wall -Werror -Wextra -L$(shell brew --prefix readline)/lib -lreadline -g -fsanitize=address
HEADERS		:=  includes
